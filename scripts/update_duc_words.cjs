...
const ducWordData = {
    'duck': { prefix: '', prefixMeaning: '', prefixMeaningEn: '', root: 'duck', rootMeaning: '鸭子', rootMeaningEn: 'duck', rootOrigin: '古英语', rootOriginNote: '源自古英语duce', suffix: '', suffixMeaning: '', suffixMeaningEn: '' }
};

let updated = 0;
words.forEach(w => {
    const wordLower = w.word.toLowerCase();
    if (ducWordData[wordLower]) {
        const d = ducWordData[wordLower];
        w.prefix = d.prefix;
...
console.log('Updated ' + updated + ' DUC words!');
