...
const damWordData = {
    'damp': { prefix: '', prefixMeaning: '', prefixMeaningEn: '', root: 'damp', rootMeaning: '潮湿', rootMeaningEn: 'damp', rootOrigin: '古英语', rootOriginNote: '源自古英语damp', suffix: '', suffixMeaning: '', suffixMeaningEn: '' }
};

let updated = 0;
words.forEach(w => {
    const wordLower = w.word.toLowerCase();
    if (damWordData[wordLower]) {
        const d = damWordData[wordLower];
        w.prefix = d.prefix;
...
console.log('Updated ' + updated + ' DAM words!');
