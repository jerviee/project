...
if (match) {
  ...
  const enTemplates = [
    ...
    'The theory provides a framework for understanding this phenomenon.',
    'Practical skills are highly valued in the workplace.',
    'Many factors contribute to the development in society.',
    'The study has made significant progress in recent years.',
    'Researchers are constantly exploring new aspects.',
    'The application has revolutionized various industries.'
  ];
