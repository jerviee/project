...
if (match) {
  ...
  const templates = [
    'Public awareness of {meaning} has increased significantly.',
    'The importance of {meaning} cannot be overstated in modern life.',
    'The theory of {meaning} provides a framework for understanding this phenomenon.',
    'Practical skills related to {meaning} are highly valued in the workplace.',
    'Many factors contribute to the development of {meaning} in society.',
    'The study of {meaning} has made significant progress in recent years.',
    'Researchers are constantly exploring new aspects of {meaning}.',
    'The application of {meaning} has revolutionized various industries.'
  ];
  ...
  words.forEach((w, idx) => {
    ...
    const enExample = templates[templateIdx].replace('{meaning}', meaning);
