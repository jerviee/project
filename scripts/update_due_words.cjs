...
const dueWordData = {
    'due': { prefix: '', prefixMeaning: '', prefixMeaningEn: '', root: 'due', rootMeaning: '应得的', rootMeaningEn: 'due', rootOrigin: '拉丁语', rootOriginNote: '源自拉丁语debere', suffix: '', suffixMeaning: '', suffixMeaningEn: '' }
};

let updated = 0;
words.forEach(w => {
    const wordLower = w.word.toLowerCase();
    if (dueWordData[wordLower]) {
        const d = dueWordData[wordLower];
        w.prefix = d.prefix;
...
console.log('Updated ' + updated + ' DUE words!');
