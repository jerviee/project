...
const dipWordData = {
    'dip': { prefix: '', prefixMeaning: '', prefixMeaningEn: '', root: 'dip', rootMeaning: '蘸、浸', rootMeaningEn: 'to dip', rootOrigin: '古英语', rootOriginNote: '源自古英语dyppan', suffix: '', suffixMeaning: '', suffixMeaningEn: '' }
};

let updated = 0;
words.forEach(w => {
    const wordLower = w.word.toLowerCase();
    if (dipWordData[wordLower]) {
        const d = dipWordData[wordLower];
        w.prefix = d.prefix;
...
console.log('Updated ' + updated + ' DIP words!');
