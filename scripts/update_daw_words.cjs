...
const dawWordData = {
    'dawn': { prefix: '', prefixMeaning: '', prefixMeaningEn: '', root: 'dawn', rootMeaning: '黎明', rootMeaningEn: 'dawn', rootOrigin: '古英语', rootOriginNote: '源自古英语dagian', suffix: '', suffixMeaning: '', suffixMeaningEn: '' }
};

let updated = 0;
words.forEach(w => {
    const wordLower = w.word.toLowerCase();
    if (dawWordData[wordLower]) {
        const d = dawWordData[wordLower];
        w.prefix = d.prefix;
...
console.log('Updated ' + updated + ' DAW words!');
