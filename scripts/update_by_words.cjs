...
const byWordData = {
    'by': {
        ...
        root: 'by', rootMeaning: '靠近、旁边', rootMeaningEn: 'by, near',
        rootOrigin: '古英语', rootOriginNote: '源自古英语bi，意为靠近、旁边',
...
words.forEach(w => {
    ...
    if (byWordData[wordLower]) {
        const d = byWordData[wordLower];
        w.prefix = d.prefix;
...
console.log('Updated ' + updated + ' BY words!');
